...
const DeleteModal = ({ setModalOpen, handleDeleteAssesment }) => {
  return (
    <>
      <div className="fixed inset-0 z-30 overflow-y-auto overflow-x-hidden flex justify-center items-center bg-black bg-opacity-50">
