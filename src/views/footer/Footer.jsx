...
const Footer = () => {
  return (
    <>
      <footer className="bg-white dark:bg-gray-900 w-full z-10">
        <div className="w-full ">
          <div className="px-4 py-4 bg-gray-100 dark:bg-gray-900 md:flex md:items-center md:justify-between w-full">
            <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
              © 2021 CodeCrew Infotech Pvt Ltd - Assessment portal
            </span>
